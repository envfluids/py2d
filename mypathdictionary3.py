    ...
    if CASENO==1:
        ...
        if NX == 128:
            if 'SMAG' in METHOD :
                ...
                # path_RL = '/mnt/Mount/jetstream_volumephy/redo/RLonKoraliGPU_CS_positiveclipping/experiments/flowControl_turb_code/'
                # path_RL += '_result_vracer_C4_N128_R_z1_State_enstrophy_Action_CS_nAgents16/CSpost'
...
def mypathdictionaryclassic(CASENO, NX, METHOD):
    ...
    if CASENO==1 or CASENO==10:
        ...
        dataType = '/mnt/Mount/jetstream_volumephy/ENVFLUIDS/'+METHOD+'/NX'+str(NX)+'/dt0.0005_IC1/data'#----------
