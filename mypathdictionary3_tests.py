    ...
    if CASENO==1:
        if NX==32:
            if 'LEITH' in METHOD :
                ...
                # path_RL = '/mnt/Mount/jetstream_volumephy/RLonKorali_beta_rewardxy_localnucs_interperiodic_deg2_range2_deterministic/experiments/flowControl_turb_code/'
                # path_RL = '/mnt/Mount/jetstream_volumephy/RLonKorali_beta_rewardxy_localnucs_interperiodic_deg2_range2_positiveclip/experiments/flowControl_turb_code/'
                # path_RL = '/mnt/Mount/jetstream_volumephy/RLonKorali_beta_rewardxy_localnucs_interperiodic_deg2_range2_zerospec/experiments/flowControl_turb_code/'
                path_RL += '_result_vracer_C1_N32_R_z1_State_invariantlocalandglobalgradgrad_Action_CL_nAgents16_CREWARD1_Tspin0.0_Thor10000.0_NumRLSteps1000.0_EPERU1.0/CLpost'
